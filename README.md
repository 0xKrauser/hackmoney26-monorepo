...
- The `@repo/inline-anchors` package contains CSUI utilities adapted from [Plasmo](https://github.com/PlasmoHQ/plasmo)
- The `@repo/emoji-picker` package contains components adapted from [Fowlerro's react-discord-components](https://github.com/fowlerro/react-discord-components)